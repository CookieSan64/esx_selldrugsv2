...
ESX.RegisterUsableItem('weed_pooch', function(source) ---## changez pour l'objet souhaité qui doit être utilisé pour la vente de drogue
	TriggerClientEvent('esx_selldrugsv2:drug', source)
end)
